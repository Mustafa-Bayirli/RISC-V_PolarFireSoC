...
set_partition_info -name "/PROC_SUBSYSTEM" -timestamp "1757190315"
set_partition_info -name "/PROC_SUBSYSTEM/PROC_SUBSYSTEM" -timestamp "1757190315"
set_partition_info -name "/PROC_SUBSYSTEM/PROC_SUBSYSTEM" -timestamp "1757190315"
set_partition_info -name "/PROC_SUBSYSTEM/PROC_SUBSYSTEM" -timestamp "1757190315"
set_compile_info \
...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Mustafa\Courses&Learning\Microchip_FPGA-SoC_Training\RISC-V_for_PolarFire\Discovery_Mi-V_tutorial\PF_MiV_Tut\synthesis\PROC_SUBSYSTEM.vm"}
set_compile_info \
    -category {"Options"} \
